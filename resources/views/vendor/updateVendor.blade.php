...
<div class="container">
    ...
    @csrf
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Vendor Name" name="party_name" value="{{ $vendor->party_name }}">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Vendor Address" name="address" value="{{ $vendor->address }}">
        </div>
